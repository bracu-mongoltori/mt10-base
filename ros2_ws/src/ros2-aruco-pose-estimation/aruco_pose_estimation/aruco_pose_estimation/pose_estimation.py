...
def pose_estimation(rgb_frame: np.array, depth_frame: np.array, aruco_dict: cv2.aruco.getPredefinedDictionary, marker_size: float,
    ...
    # new code version
    # corners, marker_ids, rejected = aruco_detector.detectMarkeArucoDetectorrs(image=rgb_frame)


    
    corners, marker_ids, rejected = cv2.aruco.detectMarkers(image=rgb_frame, dictionary=aruco_dict)
